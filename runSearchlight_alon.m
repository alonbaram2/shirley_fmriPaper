function runSearchlight_alon(Searchlight,inFiles,outFiles,rsaFunction,run,tempFilesDir,varargin)

% Alon: the only difference from the vanilla runSearchlight function in the RSA
% toolbox is the specifications of 'run' and 'tempFilesDir'
